            ...
            <div class="col-md-12">
              <div class="probootstrap-flex-block">
                <div class="probootstrap-text probootstrap-animate">
                  ...
                  <p>Un concours d'entrée en première année à l'Institut Supérieur Des Techniques Economiques Et Comptables est lancé pour les nouveaux bacheliers à ne pas manquer</p>
                  <p>
                  ...
                  <p><a href="/event2/detail2" class="btn btn-primary">Pour en savoir plus</a></p>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate">
              <a href="event5" class="probootstrap-featured-news-box">
                ...
                <div class="probootstrap-text">
                  <h3>Cérémonie de la fête de Noël</h3>
                  <span class="probootstrap-date"><i class="icon-calendar"></i>December 25, 2021</span>
                  <span class="probootstrap-location"><i class="icon-location2"></i>ISTEC, derriere Camlait Ndogbong</span>
                </div>
              </a>
            </div>

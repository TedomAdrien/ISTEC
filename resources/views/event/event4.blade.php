            ...
            <div class="col-md-12">
              <div class="probootstrap-flex-block">
                <div class="probootstrap-text probootstrap-animate">
                  ...
                  <h3>Remise des réleves de notes pour les niveaux 1</h3>
                  <p> Techniques Economiques Et Comptables est lancé pour les nouveaux bacheliers</p>
                  <p>
                    <span class="probootstrap-date"><i class="icon-calendar"></i>septembre 2, 2021</span>
                    <span class="probootstrap-location"><i class="icon-location2"></i>Campus ISTEC, derriere Camlait Ndogbong</span>
                  </p>
                  <p><a href="/event4/detail4" class="btn btn-primary"></a>Pour en savoir plus</p>
                </div>
                <div class="probootstrap-image probootstrap-animate" style="background-image: url(images/image_Events/pro.jpg)">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate">
              <a href="event5" class="probootstrap-featured-news-box">
                <figure class="probootstrap-media"><img src="images/image_Events/pro.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive"></figure>
                <div class="probootstrap-text">
                  <h3>Cérémonie de la fête de Noël</h3>

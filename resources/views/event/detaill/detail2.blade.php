          ...
          <div class="row">
            <div class="col-md-12">
             <p><h1>Description :</h1></p>
                <h3>Concours d'entrée en année</h3>
                  <p>Un concours d'entrée en première année à l'Institut Superieur Des Techniques Economiques Et Comptables est lancé pour les nouveaux bacheliers à ne pas manquer</p>

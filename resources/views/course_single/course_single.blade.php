            ...
            <div class="col-md-12">
              <div class="row probootstrap-gutter0">
                ...
                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  ...
                  <p><a href="/formations/cycle_bts" class="btn btn-primary">Inscrivez vous des maintenant !</a> <span class="enrolled-count">12,928 students enrolled</span></p>
                </div>
                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  ...
                  <p><a href="/formations/cycle_licence" class="btn btn-primary">Inscrivez vous des maintenant !</a> <span class="enrolled-count">9,928 students enrolled</span></p>
                </div>
                 <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                  ...
                  <p><a href="/formations/cycle_master" class="btn btn-primary">Inscrivez vous des maintenant !</a> <span class="enrolled-count">12,928 students enrolled</span></p>
                </div>
              </div>
            </div>
          </div>

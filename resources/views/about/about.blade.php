      ...
      <section class="probootstrap-section">
        <div class="container">
          <div class="row">
            ...
            <p>Fondé en 2012, l'institut ISTEC/ISTACO est un établissement d'enseignement supérieur spécialisé dans des domaines aussi variés que le commerce et gestion, la communication de l'information, l'industrie et les nouvelles technologies, et la formation paramédicale... </p>
      ...
      <section class="probootstrap-section">
        <div class="container">
          ...
          <div class="col-md-6 col-md-push-1">
            ...
            <p>La formation étant axée autour de la réalisation des projets, nos enseignants et nos étudiants s'investissent corps et ame pour méner à bien tous nos projets.Son offre permet aux étudiants d'adapter leur parcours au fur et à mesure de leur évolution personnelle. <br> Par exemple, Voici quelques projets réalisés par nos étudiants de 2012 à 2021:
                <ul>
                    <li>Construction de nouveaux batiments à ISTEC (bonadibo et ndogbong): par nos étudiants de BATIMENT</li>
                    ...
                    <li>Digitalisation des inscriptions (en ligne) d'ISTEC: par nos étudiants de GENIE LOGICIEL</li>

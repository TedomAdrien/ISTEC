            ...
            <div class="col-md-12">
              <div class="probootstrap-flex-block">
                <div class="probootstrap-text probootstrap-animate">
                  <h3>Nous avons embauché des enseignants certifiés pour nos étudiants</h3>
                  <p>L'avénir de nos étudiants étant leurs priorités, ces enseignants s'intègrent, se soucient et s'occupent de leur éducation.</p>
                 </div>
         ...
         <div class="row">
           ...
           <div class="col-md-3 col-sm-6">
             <div class="probootstrap-teacher text-center probootstrap-animate">
               ...
               <img src="{{ asset('images/images_teachers/homme.jpg') }}" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
               </figure>
               <div class="text">
               <h3>NTED</h3>
                 <h3>MOISE</h3>
           ...
           <div class="col-md-3 col-sm-6">
             <div class="probootstrap-teacher text-center probootstrap-animate">
               <figure class="media">
                 <img src="{{ asset('images/images_teachers/femme.jpg') }}" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
               </figure>
               <div class="text">
                 <h3>Mme CHEDJOU</h3>

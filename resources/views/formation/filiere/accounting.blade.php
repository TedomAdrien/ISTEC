...
@section('title','Hnd accounting')
      
@section('content_filiere')
       <h1 class="center j_white">Accounting</h1>
    <div class="bk_desc">
    <div class="items1">
      <div>
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>HND in Accounting aims to train professionals who are going to pursue careers
             in areas of investment analysis and management, banking, and auditing,
              consulting and financial management.</p>
      </div>
       <div class="sous_block_informations">
        ...
        <li>Strong written and oral communication.</li>
          ...
          <li>Mathematical and deductive reasoning.</li> 
       ...
       <div class="sous_block_informations">
        ...
        <ul>
        <li>Realize the management of accounting, fiscal and social operations 
            (keep accounting books, prepare financial statements, etc.)</li>

...
@section('title','Hnd marketing trade and sales')
      
@section('content_filiere')
       <h1 class="center j_white">Marketing Trade And Sales</h1>
    ...
    <div class="items1">
      ...
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>The objective of this specialty is to train intermediate staff workers for departments or services in enterprises responsible for foreign trade.
		They should have good knowledge of trade negotiations techniques and foreign markets (culture, functioning, and their peculiarities).
		Also, they should have elementary knowledge of economics and law. They should also be conversant with international logistics of trade and
		the functioning of customs.</p>
      </div>
      <div class="sous_block_informations">
        <h2>General skills</h2>
        <ol>
          <li>The understanding of the international economy</li>
          <li> The mastery of foreign languages; cross cultural</li>
          <li>The Ability to negotiate</li>
          <li>To be able to work under pressure</li>
          <li>he adaptability</li>
        </ol>
      </div>
       <div class="sous_block_informations">
        <h2>Specific skills:</h2>
        <ul>
        <li> Understand strategic logic marketing;</li>
	   		<li> Understand the challenges faced by thebusiness in a competitive environment</li>
			<li> Understand the determinants of the commercial success of thecompany</li>
			<li> Sell in anaffordable manner and cost effective;</li>
			<li> Lead a sales team toward theachievement of objective</li>
			<li> Animate a point of sale</li>
			<li> Master accounting software.</li>
        </ul>
      </div>
      <div class="sous_block_informations">
        <h2>Career Opportunities:</h2>
        <ul>
        <li> Facilitator of the sales</li>
			<li>Attached to the customership</li>
			<li>Sales representative</li>
			<li>Responsible for the sales.</li>
        </ul>
      </div>
    </div>
  </div>

...
@section('title','Hnd refrigeration and air conditioning')
      
@section('content_filiere')
       <h1 class="center j_white">Refrigeration and Air Conditioning</h1>
    <div class="bk_desc">
    <div class="items1">
      <div>
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>the programme is one that enables students to develop systems, select equipment,and commission maintain 
          and diagnose faults/malfunctions of refrigeration systems and equipment that apply to commercial food storage and preservation and air conditioning 
          and airdistribution equipment and special applications.It includes regulatory requirements for purchasing 
          and handling refrigerants.
        </p>
      </div>
       <div class="sous_block_informations">
        <h2>General skills</h2>
        <ol>
        <li>Able to work with hand and power tools</li>
          <li>Enjoy and have an aptitude for technical work</li>
          <li>Able to work patiently, systematically and thoroughly</li>
       ...
       <div class="sous_block_informations">
        ...
        <ul>
        <li>Follow plans and specifications to install, commission, service and maintain equipment.</li>
        <li>Drill holes, install mounting brackets and cut, bend and join piping.</li>
        <li>Install parts such as compressors, motors, condensers, evaporators, air filters, switches, controls and gauges.</li>
        <li>Install and connect piping to refrigeration systems</li>
        <li>Check that parts are installed, lined up and fit properly</li>
      ...
      <div class="sous_block_informations">
        ...
        <li>General Maintenance and Repair Workers</li>

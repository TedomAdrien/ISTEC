...
@section('title','Hnd industrial computing')
      
@section('content_filiere')
       <h1 class="center j_white">industrial computing</h1>
    <div class="bk_desc">
    <div class="items1">
      <div>
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>The objective of this specialty is to train professionals who may be called upon 
            to perform activities of a commercial, technical and management nature relating to insurance; impact in them knowledge on subscription modalities and indemnification of companies for losses covered by insurance and social security 
            protection through the integration of clients</p>
      </div>
       <div class="sous_block_informations">
        <h2>General skills</h2>
        <ol>
        <li>Have sales and negotiation skills;</li>
          <li>Master the legal framework of insurance;</li>
          <li>Be apt in oral and written communication</li>
          <li>Understand the professional milieu</li>
          <li>Be capable of team leadership</li>  
        </ol>
      </div> 
       <div class="sous_block_informations">
        <h2>Specific skills:</h2>
        <ul>
        <li>Identify and determine the economic and legal framework of the insurance sector;</li>
        <li>Manage relations with clients</li>
        <li> Communicate   in   a   professional,   legal,   fiscal   and   financial environment</li>
        <li> Contribute   to   obtaining   the   goodwill   of   clients   and   to   the development of the portfolio of the company;</li>
        <li>Use techniques peculiar to the different types of insurance</li>
        <li>Advise clients and propose to them insurance contracts</li>
        <li> Manage relations with clients</li>	
			</ul>
      </div>
      <div class="sous_block_informations">
        ...
        <ul>
        <li> Insurance subscriber</li>
–  <li>  Insurance expert</li>
			<li>Insurance consultant</li>
			<li>Manage individual and collective life assurance</li>
			<li>Underwriter and/or regulation</li>
            <li>Collaborator of general agents or insurance brokers</li>
        </ul>
      </div>
    </div>
  </div>

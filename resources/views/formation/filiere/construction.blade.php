...
@section('title','Hnd construction')
      
@section('content_filiere')
       <h1 class="center j_white">Construction</h1>
    <div class="bk_desc">
    <div class="items1">
      <div>
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>The  HND in Construction Management focus on the key knowledge and skills required by a technician employed in a construction management role. They cover management principles, and include a specialist core that embraces the management of construction organisations and human resources, 
            together with basic construction planning and elements of site administration</p>
      </div>
       <div class="sous_block_informations">
       ...
       <div class="sous_block_informations">
        ...
        <ul>
        <li>develops knowledge and skills in areas such as construction materials and specifications,
             site surveying, construction technology (substructure/industrial/commercial superstructure), 
             site administration, and standard forms of construction contracts.</li>
      ...
      <div class="sous_block_informations">
        ...
        <ul>
        <li>BUILDING SUPERVISOR</li>
			<li>ROAD BUILDER</li>
			<li>Sawmill sharpener</li>

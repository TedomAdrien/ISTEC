...
@section('title','Hnd Telecommunication')
      
@section('content_filiere')
       <h1 class="center j_white">Telecommunication</h1>
    ...
    <div class="items1">
      ...
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>This specialty trains senior technicians to ensure the implementation, administration and the maintenance of network or telecommunications equipment.
		Their skills in the different transmission technologies as well as their extensive knowledge of the protocols  of  the  different
		communication  networks  allow  them  to  design,  in  a group, network architectures or complex telecommunications facilities and to optimize them.</p>
      </div>
      <div class="sous_block_informations">
       ...
       <div class="sous_block_informations">
        ...
        <ul>
			...
			<li>ervicing companies and manufacturing networks equipment</li>

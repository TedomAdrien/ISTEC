...
@section('title','Hnd international trade')
      
@section('content_filiere')
       <h1 class="center j_white">International Trade</h1>
    ...
    <div class="items1">
      ...
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>This specialty aims to respond to a need expressed by businesses: surround of commercial equipped, perfectly impregnated with
		the logic marketing, sensitized on the changing needs of the consumer and oriented toward the development of sales in an environment characterized by 
		the competition.</p>
      </div>
      <div class="sous_block_informations">
        <h2>General skills</h2>
        <ol>
          <li>Understand the international economy</li>
          <li>Master other languages</li>
          <li>Be apt or skillful in negotiation</li>
          <li>understand the professional environment</li>
          <li>Be capable of working under pressure</li>
          <li> Be flexible</li>
        </ol>
      </div>
       <div class="sous_block_informations">
        ...
        <ul>
        <li> Realize the management of accounting, fiscal and social operations</li>
	   		<li> Analyze the profitability of the activities of the organization;</li>
			<li> Prepare budgets and follow up their execution;</li>
			<li> Centralize, organize and redress the accounts of the enterprise;</li>
			<li> Collaborate  efficiently  with  hierarchy  in  the  management  of  the enterprise;</li>
			<li> Control and plan production;</li>
      ...
      <div class="sous_block_informations">
        ...
        <ul>
            <li>Accountant in enterprises;</li>
			<li>Account collaborator in a firm;</li>
			<li>Assistant accountant in large companies;</li>
			<li>Payroll manager;</li>
			<li>Accounting manager;</li>
			<li>Treasurer;</li>
			<li>Management controller; etc.</li>
        </ul>
      </div>
    </div>
  </div>

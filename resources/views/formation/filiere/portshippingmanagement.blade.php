...
@section('title','Hnd port shipping management')
      
@section('content_filiere')
       <h1 class="center j_white">Port Shipping Management</h1>
    <div class="bk_desc">
    <div class="items1">
      <div>
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>It is a novelty in the domain of higher education which has been necessitated by the 
            growing importance of the sea route in the transportation of goods and people.
             From a colonial background, shipping lines have been modernized to include luxurious 
             trips and voyages around the world which has emphasized the importance of water transport. Moreover, it has also incumbent for owners of shipping vessels to recruit professionals to manage these vessels in order to adapt to the growing competition of the world. Port Shipping Management seeks to train professional managers and skilled 
            workers of this rapidly growing industry.</p>
      </div>
       <div class="sous_block_informations">
        <h2>General skills</h2>
        <ol>
        <li>possess excellent verbal and written communication skills</li>
          <li>decision making ability and a willingness to learn.</li>
          <li>The ability to work well with all levels of staff, self-motivation, confidence, a high level of numeric ability, and commercial awareness are all very important.</li>
       ...
       <div class="sous_block_informations">
        ...
        <ul>
        <li>you will study the latest management and business practices and learn to apply them to this specialist industry – 4
          exploring real-world scenarios and learning to put theory into practice</li>
	   		<li>You will get to grips with the complexities of the global transport trade, learn to manage the day-to-day operation of ships and ports, explore the intricate web of law, regulations and economic interests which manage the industry – 
           and learn how to apply that knowledge to keep the industry functioning smoothly.</li>
      ...
      <div class="sous_block_informations">
        ...
        <ul>
        <li>managers of shipping vessels</li>
			<li>Ship Captain</li>
			<li>Maritime Journalist</li>
			<li>Coast Guard Officer</li>
            <li>Professor Of Management Study</li>
        </ul>
      </div>
    </div>
  </div>

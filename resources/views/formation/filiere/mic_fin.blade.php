...
@section('title','BTS MICRO-FINANCE')
      
@section('content_filiere')
       <h1 class="center j_white">Micro-Finance</h1>
    ...
    <div class="items1">
      ...
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>Le <span>Brevet de Technicien Superieur</span> en<span> Micro-Finance</span>  vise à combler le déficit en nombre et en qualité en matière de ressources humaines dont les établissements de crédit ont besoin pour la conduite de leurs activités. En outre, elle fournit aux entreprises, quel que soit leur domaine d‟activité, des collaborateurs pouvant leur permettre de tirer le maximum des opportunités que leur offre le système financier dans son évolution, son expansion et son arrimage à la finance mondiale..</p>
      </div>
      <div class="sous_block_informations">
        <h2>Compétences Génériques:</h2>
        <ol>
          <li> Avoir la compréhension de l‟environnement professionnel et économique ;</li>
          <li> Maîtriser de la communication écrite et orale ;</li>
          <li>Avoir une aptitude à la vente et à la négociation commerciale;</li>
          <li>Maîtriser le cadre juridique de l‟activité et être apte à l‟analyse des règles fiscales applicables ;</li>
          <li>Maîtriser les TIC applicables à la banque ;</li>
          <li>Etre capable de prendre du recul face à une problématique donnée et de trouver la solution appropriée respectant   à la fois l‟attente du client et la politique commerciale de son établissement ;</li>
       ...
       <div class="sous_block_informations">
        ...
        <ul>
          <li>Construire et développer une relation de confiance, personnalisée avec chaque client, dans le cadre de la politique commerciale arrêtée par son établissement ;</li>
          <li> Développer quantitativement et qualitativement un fonds de commerce, notamment en améliorant le taux d‟équipement des clients en produits et services ;</li>
          <li>Contribuer, par son action personnelle, à un accueil de qualité ;</li>
          <li>Etre capable de prendre du recul face à une problématique donnée et de trouver la solution appropriée respectant à la fois l‟attente du client et la politique commerciale de son établissement ;</li>
          <li>Gérer et développer quantitativement et qualitativement un portefeuille de clientèle de professionnels dans le cadre de la politique commerciale arrêtée par son établissement ;</li>
          <li>Ouvrir et gérer les comptes ;</li>
          <li>Distribuer les produits et services attachés aux comptes ;</li>
          <li> Distribuer les produits d‟épargne bancaires et non bancaires et de gestion de trésorerie;</li>
          <li> Distribuer  les  produits  liés  à  l‟épargne  financière  et  notamment  ceux  dits  de  gestion collective ;</li>
          <li>Promouvoir et utiliser les technologies de transmission des informations ;</li>
          <li> Promouvoir les modes de financement du cycle d‟exploitation  et des investissements des entreprises et montage des dossiers </li>
          <li>Promouvoir  les  crédits  à  la  consommation,  des  crédits  immobiliers  aux  particuliers  et montage des dossiers ;</li>
          <li> Le suivi et gestion des risques clients ;</li>
          <li>Promouvoir les produits d‟assurance (Bancassurance) ;</li>
          <li>Conduire une analyse économique et financière de la situation du client, évaluation et suivi des risques.</li>
          <li>Contribuer au développement de son établissement par son action commerciale auprès des clients professionnels ;</li>
          <li>Développer l‟approche globale des clients professionnels, etc...</li>
        </ul>
      </div>   
      <div class="sous_block_informations">
        <h2>Débouchés:</h2>
        <ul>
          <li> Conseiller en microcrédit ;</li>
          <li> Etablissements financiers ;</li>
          <li>Chargé de clientèle ;</li>
          <li> Entreprises d'assurance ;</li>
          <li>Banque centrale ;</li>
          <li>Caissier ou guichetier ;</li>
          <li>Fondé de pouvoir d‟EMF ;</li>
          <li>  Analyste de microcrédit ;</li>
          <li>Etablissements de Microfinance, etc...</li>
        </ul>
      </div> 
    </div>
  </div>

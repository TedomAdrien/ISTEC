...
@section('title','Hnd human resource management')
      
@section('content_filiere')
       <h1 class="center j_white">Human Resource Management</h1>
    ...
    <div class="items1">
      ...
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>The objective of this specialty is to train specialists in the administrative
             follow-up of the personnel (contracts, absences, leaves, medical visits,
              declarations to labour organizations) and offering refreshment courses
               in line with the labour code; the regulation of work and the human resource
                policy of the enterprise.</p>
      </div>
      <div class="sous_block_informations">
        <h2>General skills</h2>
        <ol>
        <li> Understand    the    professional    and    economic    environment    and enterprises</li>
          <li>Master the use of the computer</li>
          <li>Administer individual salary files</li>
          <li> Effect declarations dictated by law</li>
          <li>Identify the needs for training of the personnel</li>
          <li>Define the needs for training</li>
          <li>Inform the personnel on the labour code and the peculiarities of the enterprise</li>
          <li>Lead a work team</li>
        </ol>
      </div>
       <div class="sous_block_informations">
        <h2>Specific skills:</h2>
        <ul>
        <li> Control the pay vouchers of the personnel</li>
	   		<li>Establish pay slips</li>
			<li>Carry out the administrative follow-up of human resources operations</li>
			<li>Carry out interview in view of employment</li>
			<li>Follow up outsources service contracts</li>
			</ul>
      </div>
      <div class="sous_block_informations">
        <h2>Career Opportunities:</h2>
        <ul>
        <li> Assistant human resource manager</li>
			<li>Assistant to the person in charge of human resources</li>
			<li>Assistant to the directorate</li>
			<li>Officer in charge of recruitment</li>
			<li>Central Bank</li>
            <li>Manager of salaries</li>
        </ul>
      </div>
    </div>
  </div>

...
@section('title','Hnd hardware maintenance')
      
@section('content_filiere')
       <h1 class="center j_white">Hardware Maintenance</h1>
    ...
    <div class="items1">
      ...
      <div class="sous_block_informations">
        <h2>Description:</h2>
        <p>This specialty trains senior technicians capable of maintaining and repairing computer equipment. 
		They can also install new equipment or provide training for users.</p>
      </div>
      <div class="sous_block_informations">
       ...
       <div class="sous_block_informations">
        ...
        <ul>
        <li>Diagnose remotely a computer hardware or software malfunction; Identify the resources needed to resolve the malfunction and refer the call if necessary (on-site maintenance, specialized technician ...)</li>
	   		<li>Guiding the user to resolve the malfunction or take control at a distance</li>
			<li>Identify the phases of intervention from the information of the help desk diagnosis, the hot line, the manufacturer's files;</li>
			<li>Change or repair a defective item or assembly</li>
			<li>Configure the workstation as needed by the user and perform functional tests</li>
			<li>Perform cleaning and adjustment operations on materials and equipment.</li>
         </ul>
      </div>
      <div class="sous_block_informations">
        <h2>Career Opportunities:</h2>
        <ul>
        <li> Head of IT project;</li>
			<li> Software Consultant</li>
			<li>Stock Exchange</li>
			<li>Developer of applications</li>
